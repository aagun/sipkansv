...
<div class="bg-white mx-auto max-w-[800px] rounded-lg p-[10px]" x-data="formActivityDataHandler()">
    ...
    <form class="max-w-lg mx-auto" @submit.prevent="submitHandler" novalidate>
        ...
        <div class="mb-5 flex items-center">
            ...
            <div class="relative inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
             ...
             <input datepicker datepicker-format="yyyy/mm/dd" id="inspection_date" 
             x-model="input.inspection_date" 
             @input="input.inspection_date = $event.target.value"
        ...
        <div class="mb-5 flex items-center">
            ...
            <select id="district_id" x-model="input.district_id" name="district_id" @change="fetchKecamatan()" :disabled="!province_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="mb-5 flex items-center">
            ...
            <select id="sub_district_id" x-model="input.sub_district_id" name="sub_district_id" @change="fetchDesa()" :disabled="!district_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="mb-5 flex items-center">
            ...
            <select id="village_id" x-model="input.village_id" name="village_id" :disabled="!sub_district_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="mb-5 flex items-center">
            ...
            <div class="relative inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
             ...
             <input datepicker datepicker-format="yyyy/mm/dd" id="effective_date" x-model="input.effective_date" name="effective_date" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Pilih tanggal"> 
        </div>
        <div class="mb-5 flex items-center">
        ...
        <div class="mb-5 flex items-center" x-init="fetchDropdownData('http://127.0.0.1:8000/kblis/search', 'datakbli')" >
            <label for="kbli_id" class="ml-[10px] block w-[200px] mb-2 text-sm font-medium text-gray-900 dark:text-white">KBLI</label>
            <select id="kbli_id" x-model="input.kbli_id" name="kbli_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="mb-5 flex items-center">
            ...
            <input type="number" id="perizinan_berusaha_atas_kegiatan_usaha" x-model="input.perizinan_berusaha_atas_kegiatan_usaha" name="perizinan_berusaha_atas_kegiatan_usaha" min="0" max="100" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Pemenuhan perizinan berusaha atas kegiatan usaha" required />
        </div>
        ...
        <div class="mb-5 flex items-center">
            ...
            <input type="number" id="persyaratan_umum_usaha" x-model="input.persyaratan_umum_usaha" name="persyaratan_umum_usaha" min="0" max="100" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Pemenuhan persyaratan umum usaha" required /> 
        </div>
        <div class="mb-5 flex items-center">
            ...
            <input type="number" id="persyaratan_khusus_usaha" x-model="input.persyaratan_khusus_usaha" name="persyaratan_khusus_usaha" min="0" max="100" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Pemenuhan persyaratan khusus usaha" required /> 
        </div>
        <div class="mb-5 flex items-center">
            ...
            <input type="number" id="sarana" x-model="input.sarana" name="sarana" min="0" max="100" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Pemenuhan sarana" required /> 
        </div>
        <div class="mb-5 flex items-center">
        ...
        <div class="mb-5 flex items-center">
            ...
            <input type="number" id="pelayanan" x-model="input.pelayanan" name="pelayanan" min="0" max="100" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Pemenuhan pelayanan" required /> 
        </div>
        <div class="mb-5 flex items-center">
        ...
        <div class="mb-5 flex items-center">
            ...
            <input type="number" id="pelaksanaan_kegiatan_usaha" x-model="input.pelaksanaan_kegiatan_usaha" name="pelaksanaan_kegiatan_usaha" min="0" max="100" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Penilaian pelaksanaan kegiatan usaha" required />
        </div>
        <div class="mb-5 flex items-center">
            ...
            <input type="number" id="riwayat_pengenaan_sanksi" x-model="input.riwayat_pengenaan_sanksi" name="riwayat_pengenaan_sanksi" min="0" max="100" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Riwayat pengenaan sanksi" required />
        </div>
        <div class="mb-5 flex items-center" >
            ...
            <select id="tingkat_kepatuhan_proyek" x-model="input.tingkat_kepatuhan_proyek" name="tingkat_kepatuhan_proyek" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option>Pilih Tingkat Kepatuhan Proyek</option>
        ...
        <div class="mb-5 flex items-center">
            ...
            <select id="kategory_kepatuhan" x-model="input.kategory_kepatuhan" name="kategory_kepatuhan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option>Pilih Kategori Kepatuhan</option>
