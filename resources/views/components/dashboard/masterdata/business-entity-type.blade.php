...
@section("content")
    <div class="w-full" x-data="masterDataHandler('http://127.0.0.1:8000/bet', 'http://127.0.0.1:8000/bet/search', 'http://127.0.0.1:8000/bet', 'http://127.0.0.1:8000/bet')">
        ...
        <div class="fixed w-full top-[-50px] left-0 right-0 bottom-0 bg-[rgba(243,244,246,0.7)] z-[100]"
            ...
            <div class="w-[450px] md:w-[650px] m-auto bg-white mt-[150px] rounded-lg text-center p-[15px] md:p-[30px] shadow-2xl">
                <h2 class="font-bold text-[20px]">Ubah Status Badan Usaha</h2>
        ...
        <div class="py-1 px-4 text-white bg-gray-600 w-fit rounded-r-full">
            <h2>Daftar Data Status Badan Usaha</h2>
        </div>
        ...
        <div class="w-full bg-gray-100 p-[10px] mt-[5px] border-[1px] border-gray-300 rounded-sm border-l-[3px] border-l-primary-500 mb-[10px]">
            ...
            <div class="w-full flex flex-row-reverse text-center">
                <button @click="isShowForm = !isShowForm" class="text-[15px] font-bold text-gray-600 hover:text-gray-800 inline-flex items-center justify-center px-[10px] focus:outline-none bg-gray-300 hover:bg-gray-400 rounded-[100px]"><span x-show="isShowForm">X</span><span x-show="!isShowForm">Tambah Status Badan Usaha</span></button>
            </div>
        </div>
