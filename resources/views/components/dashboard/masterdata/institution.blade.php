...
@section("content")
    <div class="w-full" x-data="masterDataHandler('http://127.0.0.1:8000/institutions', 'http://127.0.0.1:8000/institutions/search', 'http://127.0.0.1:8000/institutions', 'http://127.0.0.1:8000/institutions')">
        ...
        <div class="w-full bg-gray-100 p-[10px] mt-[5px] border-[1px] border-gray-300 rounded-sm border-l-[3px] border-l-primary-500 mb-[10px]">
            ...
            <div class="w-full flex flex-row-reverse text-center">
                <button @click="isShowForm = !isShowForm" class="text-[15px] font-bold text-gray-600 hover:text-gray-800 inline-flex items-center justify-center px-[10px] focus:outline-none bg-gray-300 hover:bg-gray-400 rounded-[100px]"><span x-show="isShowForm">X</span><span x-show="!isShowForm">Tambah Instansi</span></button>
            </div>
        </div>
