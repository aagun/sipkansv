    ...
    <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex justify-start items-center">
            <button
                ...
                class="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer lg:hidden navbar__toggle"
            >
                <svg
                    aria-hidden="true"
                    class="w-6 h-6"
            ...
            <a href="#" class="flex items-center justify-between mr-4">
                <img alt="logo_sipkan" class="h-fit w-[30px] md:w-[50px] mr-3"
                     src="{{asset("assets/img/logo.png")}}"/>
                <span
                    class="self-center text-xl md:text-2xl font-semibold whitespace-nowrap dark:text-white">SIPKAN</span>
            </a>
        </div>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button
                ...
                class="p-2 mr-1 text-gray-500 rounded-lg "
            >
            ...
            <div
                ...
                <div>
                    <a href="#" class="flex py-3 px-4 border-b hover:bg-primary-100 dark:hover:bg-gray-600 dark:border-gray-600">
                    ...
                    <a href="#" class="flex py-3 px-4 hover:bg-primary-100 dark:hover:bg-gray-600">
                        <div class="flex-shrink-0">
                            <img
                                class="w-11 h-11 rounded-full"
