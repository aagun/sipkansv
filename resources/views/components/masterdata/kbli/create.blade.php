...
<div :id="$store.{{$key}}.prefix + '_createModal'" tabindex="-1"
     aria-hidden="true"
            ...
            <form class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                            ...
                            :data-modal-hide="$store.{{$key}}.prefix + '_createModal'">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select :id="$store?.{{$key}}?.options?.data?.sub_sector_id?.id"
                                ...
                                <option selected="" x-text="$store.{{$key}}?.options?.data?.sub_sector_id?.default_placeholder_name"></option>
                            </select>
                        </div>
...
{{--                            <template x-if="item?.input">--}}
{{--                                <div :class="item?.class">--}}
{{--                                    <label :for="item.id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" x-html="item.label">--}}
{{--                                    </label>--}}
{{--                                    <input :type="item.type" :name="item.name" :id="item.id" x-model="item.value"--}}
{{--                                           class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">--}}
{{--                                </div>--}}
{{--                            </template>--}}
{{--                            <template x-if="item?.select">--}}
{{--                                <div>--}}
...
{{--                        </template>--}}
                ...
                <div
                    ...
                    <button
                        ...
                        :data-modal-toggle="$store.{{$key}}.prefix + '_createModal'"
