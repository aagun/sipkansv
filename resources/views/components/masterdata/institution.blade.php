    ...
    <div class="w-full" x-data="{isDelete: false, isShowForm: false, isShowFormEdit: false}">
        ...
        <div class="absolute w-full top-[-50px] left-0 right-0 bottom-0 bg-[rgba(243,244,246,0.7)] z-[100]"
            ...
            <div
                ...
                <h2 class="font-bold text-[20px]">Ubah Instansi</h2>
                <form action="">
                    @csrf
                    <div class="space-y-6 bg-white">
                        ...
                        <div class="items-center w-full p-4 space-y-4 text-gray-800 md:inline-flex md:space-y-0">
                            ...
                            <div class="max-w-lg mx-auto md:w-4/5">
                                <div class=" relative">
                                    <textarea id="content" name="description" type="text"
                                              class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-600 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent"
                        ...
                        <div class="w-[200px] flex justify-between m-auto mt-[30px]">
                            ...
                            <button @click="isShowFormEdit = !isShowFormEdit"
                                    class="py-1 px-2 bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                Batalkan
                            </button>
                        </div>
        ...
        <div
            ...
            <div class="w-full flex flex-row-reverse text-center">
                <button @click="isShowForm = !isShowForm"
                    ...
                    <span x-show="isShowForm">X</span><span x-show="!isShowForm">Tambah Instansi</span></button>
            </div>
        </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            ...
                            elit. Veritatis alias ducimus ipsa doloribus, architecto beatae laborum magni id quam
                            blanditiis assumenda provident dicta voluptas nihil voluptates ex soluta inventore eos.
                        </td>
                        <td class="px-6 py-4">
                            <button @click="isShowFormEdit = !isShowFormEdit"
                                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1">Ubah
                            </button>
                            <button @click="isDelete = !isDelete"
