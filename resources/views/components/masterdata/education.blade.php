...
@section("content")
    <div class="w-full"
         x-data="masterDataHandler('http://127.0.0.1:8000/educations', 'http://127.0.0.1:8000/educations/search', 'http://127.0.0.1:8000/educations', 'http://127.0.0.1:8000/educations')">
        <div x-show="deleteMessage"
             class="flex items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800 fixed z-[100]"
             role="alert">
            <div x-text="deleteMessage" class="ms-3 text-sm font-medium">
            </div>
        </div>
        <div x-show="editMessage"
             class="flex items-center p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800 fixed z-[100]"
             role="alert">
        ...
        <div class="fixed w-full top-[-50px] left-0 right-0 bottom-0 bg-[rgba(243,244,246,0.7)] z-[1000]"
             ...
             x-transition:leave-end="opacity-0 scale-95">
            <div
                    class="w-[450px] md:w-[650px] m-auto bg-white mt-[150px] rounded-lg text-center p-[15px] md:p-[30px] shadow-2xl">
                    ...
                    <div class="space-y-6 bg-white">
                        ...
                        <div class="items-center w-full p-4 space-y-4 text-gray-800 md:inline-flex md:space-y-0">
                            ...
                            <div class="max-w-lg mx-auto md:w-4/5">
                                <div class=" relative ">
                                    <input type="text" x-model="itemToEdit.name" name="name"
                                           class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-600 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent"
                        ...
                        <div class="items-center w-full p-4 space-y-4 text-gray-800 md:inline-flex md:space-y-0">
                            ...
                            <div class="max-w-lg mx-auto md:w-4/5">
                                <div class=" relative">
                                    <textarea id="content" x-model="itemToEdit.description" name="description"
                                              type="text"
                                              class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-600 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent"
                        ...
                        <div class="w-[200px] flex justify-between m-auto mt-[30px]">
                            ...
                            <button type="reset" @click="isShowFormEdit = !isShowFormEdit"
                                    class="py-1 px-2 bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                Batalkan
                            </button>
                        </div>
        ...
        <div
                class="w-full bg-gray-100 p-[10px] mt-[5px] border-[1px] border-gray-300 rounded-sm border-l-[3px] border-l-[#009142] mb-[10px]">
            <div x-show="isShowForm"
                 class="rounded-xl border-gray-400 border-[1px] mb-[10px] p-[5px] bg-white shadow-md"
                 x-transition:enter="transition ease-out duration-100 transform"
                 x-transition:enter-start="opacity-0 scale-95"
                 x-transition:enter-end="opacity-100 scale-100"
                 x-transition:leave="transition ease-in duration-75 transform"
                ...
                <form @submit.prevent="createSubmit" novalidate>
                    ...
                    <div class="space-y-6 bg-white">
                        <div x-show="successMessage" class="mb-4 p-4 bg-green-200 text-green-800"
                        ...
                        <div class="items-center w-full p-4 space-y-4 text-gray-800 md:inline-flex md:space-y-0">
                            ...
                            <div class="max-w-lg mx-auto md:w-4/5">
                                <div class=" relative">
                                    <textarea id="content" x-model="description" name="description" type="text"
                                              class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-600 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent"
                                              placeholder="Deskripsi" required></textarea>
            ...
            <div class="w-full flex flex-row-reverse text-center">
                <button @click="isShowForm = !isShowForm"
                        class="text-[15px] font-bold text-gray-600 hover:text-gray-800 inline-flex items-center justify-center px-[10px] focus:outline-none bg-gray-300 hover:bg-gray-400 rounded-[100px]">
                    <span x-show="isShowForm">X</span><span x-show="!isShowForm">Tambah Pendidikan</span></button>
            </div>
        </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <template x-for="(item, index) in items" :key="item.id">
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <button @click="getEditData(item.id)"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1"
                                        value={item.id}>Ubah
                                </button>
                                <button @click="confirmDelete(item.id)"
                                        class="mx-1 font-medium text-red-600 dark:text-red-500 hover:underline">Hapus
                                </button>
                            </td>
                        </tr>
                    </template>
