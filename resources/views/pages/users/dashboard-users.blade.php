...
@section("content")
    <div class="w-full" x-data="{isShowSearch: true, isDelete:false}">
        ...
        <div class="w-full">
            ...
            <div
                    class="w-full bg-gray-100 p-[10px] mt-[5px] border-[1px] border-gray-300 rounded-sm border-l-[3px] border-l-[#009142]">
                    ...
                    <form action="">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="text"
                                           class="border-gray-400 border-[1px] focus:outline-none focus:ring-2 focus:ring-[#009142] focus:border-transparent px-2">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><select name="" id=""
                                            class="border-gray-400 border-[1px] focus:outline-none focus:ring-2 focus:ring-[#009142] focus:border-transparent px-2 w-[200px]">
                        ...
                        <div class="my-[10px] text-white">
                            <button type="submit"
                                    class="bg-[#09afed] hover:bg-blue-600 active:bg-blue-800 rounded-sm px-3 py-1"><i
                                        class="fas fa-search mr-[5px]"></i>Cari
                            </button>
                            <button class="bg-[#09afed] hover:bg-blue-600 active:bg-blue-800 rounded-sm px-3 py-1"><i
                                        class="fas fa-undo-alt mr-[5px]"></i>reset
                            </button>
                        </div>
                    </form>
                </div>
                <div class="w-full flex flex-row-reverse text-center">
                    <button @click="isShowSearch = !isShowSearch"
                        ...
                        <span x-show="isShowSearch">X</span><span x-show="!isShowSearch">Cari Pengguna</span></button>
                </div>
            </div>
        </div>
        ...
        <div class="w-full">
            <div class="mt-[20px] mb-[10px]  flex justify-between">
                <a href="/dashboard/users/create"
                   class="py-2 px-4  bg-green-600 hover:bg-green-700 focus:ring-green-500 focus:ring-offset-green-200 text-white w-fit transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ">Tambah
                    Pengguna</a>
            </div>
                ...
                <table class="table p-4 bg-gray-100 rounded-lg shadow">
                    ...
                    <tr class="text-gray-700">
                        ...
                        <td class="border p-4 dark:border-dark-5 flex gap-2">
                            ...
                            <button @click="isDelete = !isDelete" type="button"
                                    class="py-1 px-2 bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                Hapus
                            </button>
                        </td>
                    </tr>
