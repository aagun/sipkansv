...
@section('content')
    <div class="bg-white mx-auto max-w-[800px] rounded-lg p-[10px]" x-data="formActivityDataHandler()">
        ...
        <form class="max-w-lg mx-auto" @submit.prevent="submitHandler">
            ...
            <div class="mb-5 flex items-center">
                <label for="effective_date" class="ml-[10px] block w-[200px] mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Terbit/Perubahan<br/>(dd-mm-yyyy)</label>
            ...
            <div class="mb-5 flex items-center" x-init="fetchDropdownData('http://127.0.0.1:8000/sub-sectors/search', 'dataSubSektor')" >
                ...
                <select id="sub_sector_id" x-model="input.sub_sector_id" name="sub_sector_id" @change="fetchDropdownkbli('http://127.0.0.1:8000/kblis/search', 'datakbli')" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
