...
@section('content')
    ...
    <div x-data>
        ...
        <div class="mt-2 w-full p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col md:flex-row gap-3 justify-center md:justify-start mb-4">
                <button
                ...
                <button
                    onclick="_sipkan_clearFilterBootstrapTable()"
                    type="button"
        ...
        <!-- create modal -->
        <x-masterdata.kbli.create key="{{Str::camel($APP_PREFIX)}}StoreCreate"/>

        <!-- Edit modal -->
        <x-masterdata.kbli.edit key="{{Str::camel($APP_PREFIX)}}StoreEdit"/>
