...
class BusinessScaleControllerTest extends TestCase
{
    ...
    public function testUpdateSuccess()
    {
        ...
        $model = BusinessScale::query()->first();
        $payload = [
            'id' => $model->id,
        ...
        $this->assertDatabaseHas(BusinessScale::class, ['name' => $model->name . 'UPDATE_NAME']);
        ...
        $response->assertStatus(Response::HTTP_OK);
        $response->assertJsonFragment(['message' => __('messages.success.updated')]);
        $this->assertDatabaseHas(BusinessScale::class, ['description' => $model->description . 'UPDATE_NAME']);
    }
