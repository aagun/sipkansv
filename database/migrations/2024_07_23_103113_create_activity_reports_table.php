...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('activity_reports', function (Blueprint $table) {
            ...
            $table->decimal('kepatuhan_teknis');
            $table->decimal('perizinan_berusaha_atas_kegiatan_usaha');
            $table->decimal('persyaratan_umum_usaha');
            $table->decimal('persyaratan_khusus_usaha');
            $table->decimal('sarana');
            $table->decimal('organisasi_dan_sdm');
            $table->decimal('pelayanan');
            $table->decimal('persyaratan_produk');
            $table->decimal('sistem_manajemen_usaha');
            $table->decimal('kepatuhan_administratif');
            $table->decimal('pelaksanaan_kegiatan_usaha');
            $table->decimal('riwayat_pengenaan_sanksi');
