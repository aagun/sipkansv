    ...
    public function run(): void
    {
        $users = [
            [
                ...
                'department_id' => $this->departmentService->search(['name' => 'Unit Pelaksana Teknis Daerah Penggawasan Sumber Daya Kelautan dan Perikanan Wilayah Selatan'])->first()->id,
                'institution_id' => $this->institutionService->search(['name' => 'Dinas Kelautan dan Perikanan Provinsi Jawa Barat'])->first()->id,
            ...
            [
                ...
                'department_id' => $this->departmentService->search(['name' => 'Unit Pelaksana Teknis Daerah Penggawasan Sumber Daya Kelautan dan Perikanan Wilayah Utara'])->first()->id,
                'institution_id' => $this->institutionService->search(['name' => 'Dinas Kelautan dan Perikanan Provinsi Jawa Barat'])->first()->id,
            ...
            [
                ...
                'department_id' => $this->departmentService->search(['name' => 'Bidang Pengawasan Sumber Daya Kelautan dan Perikanan'])->first()->id,
                'institution_id' => $this->institutionService->search(['name' => 'Dinas Kelautan dan Perikanan Provinsi Jawa Barat'])->first()->id,
